...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]bwbuild[/B][/COLOR]Wizard'
BUILDERNAME = 'bwbuild'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]bwbuild[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing bwbuild.\n\nContact us on at http://bwbuild.atwebpages/'
...
REPOADDONXML = 'http://bwbuild.atwebpages/matrix/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'http://bwbuild.atwebpages/matrix/zips/repository.bwbuild'
#########################################################
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]bwbuild[/B][/COLOR]Wizard'
